...
DEFINE_BASECLASS "weapon_predatorbase"
...
CreateConVar("predator_no_nade_throw_during_prep", "0")
...
if (CLIENT) then 
   function SWEP:DrawHUD()
      ...
      draw.SimpleText(self:Clip1() .. " remaining", "TabLarge", x + 60, y + 30, COLOR_RED, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
   end
end
...
function SWEP:OnRemove()
   ...
   --    RunConsoleCommand("use", "weapon_predator_unarmed")
   -- end
end
