...
function PLAYER:Loadout()
    ...
    self.Player:GiveAmmo(30, "PISTOL", true)
    self.Player:Give("weapon_predator_glock")
    self.Player:Give("weapon_predator_crowbar")
    self.Player:Give("weapon_predator_slam")
    -- self.Player:AllowFlashlight(true)
    self.Player:AllowFlashlight(false)
end

player_manager.RegisterClass("human_flashlight", PLAYER, "player_default")